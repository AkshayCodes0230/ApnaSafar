...
import { Instagram, Facebook } from 'lucide-react';
 ...
 export default function App() {
  return (
    <div className="relative min-h-screen bg-slate-200 p-4 md:p-8 lg:p-12 selection:bg-brand-primary selection:text-white">
      <div className="relative bg-brand-accent flex flex-col font-sans text-slate-900 overflow-hidden border-8 border-white shadow-2xl rounded-[3rem]">
        <Navbar />
      ...
      <div className="fixed bottom-12 right-12 flex flex-col items-center gap-4 z-[100]">
        ...
        <a 
          href="https://wa.me/919876543210?text=Hello%21%20I%27m%20interested%20in%20booking%20an%20adventure%20with%20Apna%20Safar." 
          target="_blank" 
          rel="noopener noreferrer"
